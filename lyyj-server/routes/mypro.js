...
router.post("/login",(req,res)=>{
	...
	var sql="select * from lyyj_user where uname=? and upwd=?";
...
router.get("/deluser",(req,res)=>{
	...
	var sql="delete from lyyj_user where uid=?";
...
router.get("/query",(req,res)=>{
	...
	var sql="select * from lyyj_user where uid=?";
	pool.query(sql,[$uid],(err,result)=>{
		if(result.length>0){
			res.send(result[0]);
		}else{
...
router.post("/update",(req,res)=>{
	...
	var sql="update lyyj_user set uname=?,"
